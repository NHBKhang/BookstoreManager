...
app.add_url_rule('/api/sales/<string:book_id>', 'update-sales-cart', controllers.update_sales_cart,
                 methods=['PUT', 'DELETE'])
app.add_url_rule('/invoice', 'pay-invoice', controllers.pay_invoice, methods=['POST', 'GET'])
app.add_url_rule('/invoice/export', 'export-invoice', controllers.export_invoice, methods=['POST', 'GET'])
app.add_url_rule('/invoice/return', 'invoice-return', controllers.invoice_return, methods=['POST', 'GET'])
